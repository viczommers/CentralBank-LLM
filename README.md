...
> [!TIP]
> [Lambda Capture](https://github.com/lambda-capture/) is glad to announce our Prod-level Vector Store that morally supersedes my Repo
> - [Model Context Protocol (MCP)](https://github.com/lambda-capture/mcp-server) (Plug-n-Play integration of our tools into your Agent)
> - [REST API for Semantic Search](https://github.com/lambda-capture/semantic-search-api) (on-demand context)
> - ⭐ Like what you see? Give us a start!
...
## Citation:
If you use this software in your research or work, please cite it following [CITATION.cff](CITATION.cff), or the following APA entry:<br>
`Zommers, V. (2023). Central Bank Speak RAG-LLM [Computer software]. GitHub. https://github.com/viczommers/CentralBank-LLM/`

## [**Get in Touch**](mailto:vic.dashboards@icloud.com?subject=[GitHub]%20LLM%20Dashboard)
Interested in discussing AI in Finance?
